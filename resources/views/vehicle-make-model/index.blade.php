    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex justify-content-between action-bar">
            ...
            <div id="table-actions" class="d-block d-lg-flex align-items-center">
                    <x-forms.link-primary :link="route('vehicle-make-model.create')" class="mr-3 openRightModal" icon="plus">
                        @lang('app.menu.addMakeModel')
...
@push('scripts')
    ...
    <script>
        ...
        const showTable = () => {
            window.LaravelDataTables["vehicle-make-model-table"].draw(false);
        }
        ...
        $('body').on('click', '.delete-table-row', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('vehicle-make-model.destroy', ':id') }}";
