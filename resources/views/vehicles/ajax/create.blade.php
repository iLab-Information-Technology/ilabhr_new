    ...
    <div class="col-sm-12">
        <x-form id="save-vehicle-data-form">
            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="col-lg-3">
                    <x-forms.datepicker fieldId="date" :fieldLabel="__('modules.vehicles.date')" fieldName="date" fieldRequired="true"
                        :fieldPlaceholder="__('modules.vehicles.date')" />
                </div>

                <div class="row p-20">
                    <div class="col-md-4">
                        <x-forms.text fieldId="ilab_id" :fieldLabel="__('modules.vehicles.ilab_id')" fieldName="ilab_id" fieldRequired="true"
                ...
                <div class="row  p-20">
                    ...
                    <div class="col-md-4">
                        <x-forms.text fieldId="vehicle_plate_number" :fieldLabel="__('modules.vehicles.number_plate')" fieldName="vehicle_plate_number"
                    ...
                    <div class="col-md-4">
                        <x-forms.select fieldId="color" :fieldLabel="__('modules.vehicles.color')" fieldName="color" fieldRequired="true"
                ...
                <div class="row p-20 d-none" id="replacementRow">
...
<script>
    $(document).ready(function() {
        ...
        $('#save-more-vehicle-form').click(function() {
            ...
            const url = "{{ route('vehicles.store') }}";
