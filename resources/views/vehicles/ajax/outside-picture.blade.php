...
<div class="modal-body">
    <div class="portlet-body">
        <x-form id="save-other-report-data-form" method="PUT" class="ajax-form">
            <div class="row">
                <div class="col-lg-12">
                    <x-forms.file allowedFileExtensions="png jpg jpeg svg pdf doc docx" class="mr-0 mr-lg-2 mr-md-2" :fieldValue="asset('user-uploads/vehicle-images/'. $vehicle->images[0]->firstWhere('type', 'outside')->image)"
                        :fieldLabel="__('modules.vehicles.outsidePictures')" fieldName="outside_image"
                        fieldId="file">
                    </x-forms.file>
                </div>
            </div>
