...
<head>
    ...
    @includeIf('receipt-voucher.pdf.invoice_pdf_css')
    <style>
        .bg-grey {
...
<body class="content-wrapper">
    <table class="bg-white" border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
        <tbody>
            <!-- Table Row Start -->
            <tr>
                <td><img src="{{ $invoiceSetting->logo_url }}" alt="" id="logo" /></td>
                <td align="right" class="f-21 text-black font-weight-700 text-uppercase">سند القبض<br>
                    <table class="text-black mt-1 f-11 b-collapse rightaligned">
                        <tr>
                            <td class="heading-table-left">رقم القسيمة</td>
                ...
                @endif --}}
                        <tr>
                            <td class="heading-table-left">تاريخ القسيمة</td>
                        ...
                        @if (empty($receipt_voucher->voucher_number) &&
                            ...
                            <tr>
                                ...
                                <td class="heading-table-right">
                                    {{ $invoice->end_date->translatedFormat(company()->date_format) }}
                                </td>
                            </tr>
                        @endif
                    </table>
            ...
            <tr>
                <td class="f-12 text-black">
                    <p class="line-height mb-0 ">
                        <span class="text-grey text-capitalize">وصفت من</span><br>
                    ...
                    @if (
                        ...
                        <p class="line-height mb-0">
                            ...
                            @if ($client->mobile && $invoiceSetting->show_client_phone == 'yes')
                                {{ $client->work_mobile_with_phone_code }}<br>
                            @endif
    ...
    <table width="100%" class="f-14 b-collapse">
        ...
        <tr class="main-table-heading text-grey">
            <td>مدينة</td>
            <td align="center">رقم الاقامة</td>
            <td align="center">رقم الحساب</td>
            <td align="center">عمل</td>
            <td align="right" width="{{ $invoiceSetting->hsn_sac_code_show ? '20%' : '23%' }}">
                اعمال اخرى
            </td>
        </tr>
        <!-- Table Row End -->
        ...
        <tr class="main-table-heading text-grey">
            <td class="border-right-0" width="35%">توقيع المحاسب</td>
        ...
        <tr class="f-12 main-table-items text-black">
            <td style="padding: 50px 10px 2px 10px" align="center">___________________________________</td>
            <td style="padding: 50px 10px 2px 10px" align="center">________________________________</td>
            <td style="padding: 50px 10px 2px 10px" align="center" colspan="3">________________________</td>
        </tr>
            ...
            <tr class="text-grey">
                @if (
                    $invoiceSetting->authorised_signatory &&
                        ...
                        $receipt_voucher->status == 'paid')
                    <td class="" align="right">
                        <img style="height:95px; margin-bottom: -50px; margin-top: 5px; margin-right: 20"
                            src="{{ $invoiceSetting->authorised_signatory_signature_url }}" alt=""
                            id="logo" /><br>
