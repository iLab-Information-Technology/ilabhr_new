    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex justify-content-between action-bar">
            ...
            <div id="table-actions" class="d-block d-lg-flex align-items-center">
                    <x-forms.link-primary :link="route('vehicle-rental-company.create')" class="mr-3 openRightModal" icon="plus">
                        @lang('app.menu.addRentalCompany')
...
@push('scripts')
    ...
    <script>
        ...
        const showTable = () => {
            window.LaravelDataTables["rental-company-table"].draw(false);
        }
        ...
        $('body').on('click', '.delete-table-row', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('vehicle-rental-company.destroy', ':id') }}";
