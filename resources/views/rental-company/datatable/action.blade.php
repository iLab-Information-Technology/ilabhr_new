<div class="task_view">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink-{{ $id }}"
            ...
            <a class="dropdown-item openRightModal" href="{{ route('vehicle-rental-company.edit', [$id]) }}">
                <i class="fa fa-edit mr-2"></i>
                {{ trans('app.edit') }}
            </a>

            <a class="dropdown-item delete-table-row" href="javascript:;" data-vehicle-id="{{ $id }}">
